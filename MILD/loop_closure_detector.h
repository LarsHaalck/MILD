...
{
public:
    LoopClosureDetector(int feature_type, int para_table_num, int input_depth_level,
...
private:
    ...
    std::vector<float> lut_feature_similarity; // feature_similarity look up table based
                                               // on hamming distance
